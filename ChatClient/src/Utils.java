...
public class Utils {
	...
	public static final String CLICK_SOUND = "Å¬¸¯.mp3";
	public static final String MOUSEIN_SOUND = "¹öÆ°.mp3";
	...
	public static BufferedImage resize(BufferedImage img) {
		...
		g.setRenderingHint(RenderingHints.KEY_INTERPOLATION, RenderingHints.VALUE_INTERPOLATION_BILINEAR); // °Á ±×·±°¡º¸´Ù ÇØ
	...
	public static void setLabelToDefaultFont(JLabel lbl) {
		lbl.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
